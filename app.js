...
// function City(cnames,anames){
//     this.cityname = cnames,
//     this.areaname = anames
// }
// let mycountry = new City(" landhi karachi","future coluny")
// console.log(mycountry);

// function User(gfather,gmother){
//     this.grandfather = gfather,
//     this.grandmother = gmother
// }
// let myfamliy = new User("Abdul Kareem","zaitoony bibi")
// console.log(myfamliy);
// function User(wnames,cnames,anames){
//     this.worldname = wnames,
//     this.cityname = cnames,
//     this.areaname = anames
// }
// let mycountry = new User("pakistan","landhi karachi","future coluny")
// console.log(mycountry);




// let num1 =["by","nhi","hn","kia","q"]
// num2.pop()
// console.log(num1);
// let by = num1.push("is")
// let og = num1.shift()
// let dd = num1.unshift(23)
